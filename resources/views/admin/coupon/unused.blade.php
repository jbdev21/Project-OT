            ...
            <div class="x_panel">
                <div class="x_title">
                    <label>@lang('menu.coupon')</label>
                        ...
                        <a class="btn btn-default btn-sm" href="{{ route('admin.coupon.index') }}"><i class="fa fa-reply-all"></i> @lang('label.coupon')</a>
                        <button class="btn btn-default btn-sm" id="delete_all_btn"><i class="fa fa-trash"></i> @lang('button.delete')</button>
                    </div> 
                <form action="{{route('admin.coupon.destroy', 0)}}" id="delete_all" method="post">
                    {{csrf_field()}}
                    {{method_field('DELETE')}}
