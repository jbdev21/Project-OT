...
@section('content')
   <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="row">
            <form action="{{ route('admin.popup.update', $popup->id) }}" method="post">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
                    <div class="col-sm-2">
                ...
                <div class="col-sm-8">
                    ...
                    <h2 class="sub-header">@lang('label.apperance')</h2>
                            <div class="padding-sm">
                                <label for="">타이틀 *</label>
                                <input type="text" name="title" value="{{$popup->title}}" require class="form-control">
                                <br>
                                <div class="position-selection">
                                    <label for="position">@lang('label.position')</label>
                                    <br>

                                    <input type="radio" @if($popup->position == "center") checked @endif id="center" name="position" value="center">
                                    <label for="center" class="btn btn-default position">
                                    @lang('label.center')
                                    </label>
                                    
                                    <input type="radio" id="top" @if($popup->position == "top") checked @endif  name="position" value="top">
                                ...
                                <div class="colors">
                                    <label for="color" class="btn btn-sm btn-default"> <input type="color" id="color" name="title_color" value="{{$popup->title_color}}"> @lang('label.title_color')</label>
                                  
                                    <label for="background_color"  class="btn btn-sm btn-default"> <input type="color"  value="{{$popup->background_color}}" id="background_color" name="background_color"> @lang('label.background_color')</label>
                                    
                                    <label for="text"  class="btn btn-sm btn-default"> <input type="color" id="text"  value="{{$popup->text_color}}" name="text_color"> @lang('label.text_color')</label>
                                    
                                    <label for="button_text_color"  class="btn btn-sm btn-default"> <input type="color"  value="{{$popup->button_text_color}}" id="button_text_color" name="button_text_color"> @lang('label.button_text_color')</label>
                                    
                                    <label for="button_color"  class="btn btn-sm btn-default"> <input type="color"  value="{{$popup->button_color}}" id="button_color" name="button_color"> @lang('label.button_color')</label>
                        ...
                        <div role="tabpanel" class="tab-pane" id="content">
                            ...
                            <div class="padding-sm">
                                ...
                                <textarea class="form-control"  id="my-editor" require   name="description"  rows="6">{{$popup->description}}</textarea>
                                ...
                                <input type="text"  name="button_link"  value="{{$popup->button_link}}"  class="form-control">
                            </div>
                        <br>
                        ...
                        <h2 class="sub-header">@lang('label.publish')</h2>
                            <div class="padding-sm">
                                ...
                                <input type="date" name="date_start" value="{{$popup->date_start}}" require class="form-control"> 
                                <br>

                                <label for="">@lang('label.end_of_display')</label>
                                <input type="date" name="date_end"  value="{{$popup->date_end}}"  class="form-control">
                                <br>

                                <label for="">@lang('label.load_to_display')</label>
                                 <select name="display_load" id="" class="form-control">\
                                    <option value="every_load" @if($popup->display_load == "every_load") selected @endif >@lang('label.every_homepage_load')</option>
                                    <option value="first_load" @if($popup->display_load == "first_load") selected @endif >@lang('label.just_on_first_load')</option>
                                 </select>
                            </div>
                        <br>
                            ...
                            <h2 class="sub-header">@lang('label.publish')</h2>
                            <div class="padding-sm">
                                <label><input type="checkbox" name="show" @if($popup->show) checked @endif> @lang('label.show') </label>
