    ...
    <div class="container">
        <ul class="nav nav-tabs" role="tablist" style="">
            <li role="presentation" class="active">
              <a href="#register"  class="btn btn-primary" style="color:white " aria-controls="register" role="tab" data-toggle="tab">
                무료체험 신청
              </a>
            </li>
            <li role="presentation">
              <a href="#logintest" aria-controls="logintest"  class="btn btn-primary" style="color:white" role="tab" data-toggle="tab">
               체험수업 진행 및 결과보기
              </a>
            </li>
            <li role="presentation">
                <a href="http://ontalk.co.kr/notice/1536823795" class="btn btn-primary" style="color:white" aria-controls="logintest" >체험수업 진행방법 확인</a>
            </li>
        </ul>
                ...
                <form action="{{route('leveltest.store')}}" id="leveltest_from" method="post">
                    <div class="row" id="form-div">
                        ...
                        <div class="form-group" id="checkmobile-div" >
                            <label  class="control-label">@lang('label.contact_number') <small id="in-use-message" style="display: none;">&nbsp;&nbsp;  * 등록된 번호 입니다</small></label>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#checkmobile').change(function(){
                var mobile = $(this).val();
                if(mobile.length){
                    $.get('{{url('/api/validatemobile')}}/' + mobile, function(data){
                        console.log(data)
                        if(data != 0){
            ...
            $('#leveltest-login').submit(function(e){
                ...
                $.post(url, data, function(data){
                     if(data.status){
                        window.open('{{url('/leveltest')}}', '_self')
                    }else{
