<template>
    <div>
            ...
            <class-show-list-mobile :today="today" :rangedefault="rangedefault" :classid="classid" :perpage="20" @sessionclicked="selected_session = $event" ></class-show-list-mobile>
            <br>
            <class-list-info-mobile :session="selected_session" ></class-list-info-mobile>
            <hr>
            ...
            <hr>
            <class-book-mobile :classid="classid" ></class-book-mobile>
            <hr>
