            ...
            <div class="col-sm-5">
                <table  class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        :class="{ 
                                    ...
                                    warning: class_item.status == 'delay',  
                ...
                <table class="table">
                    <tr>
                        <td>듣기:</td>
                        <td>
                        <star-rating :starSize="30"  :read-only="true" :max-rating="10"  :rating="session.comprehension" ></star-rating>
                        </td>
                    </tr>
                    <tr>
                        <td>말하기:</td>
                        <td>
                        <star-rating :starSize="30"  :read-only="true" :max-rating="10"  :rating="session.pronounciation" ></star-rating>
                    ...
                    <tr>
                        <td>발음:</td>
                        <td>
                        <star-rating :starSize="30"  :read-only="true" :max-rating="10"  :rating="session.fluency" ></star-rating>
                    ...
                    <tr>
                        <td>단어:</td>
                        <td>
                        <star-rating :starSize="30"  :read-only="true" :max-rating="10"  :rating="session.vocabulary" ></star-rating>
                        </td>
                    </tr>
                    <tr>
                        <td>문법:</td>
                        <td>
                        <star-rating :starSize="30"  :read-only="true" :max-rating="10"  :rating="session.grammar" ></star-rating>
                    ...
                    <!-- <tr>
                        <td><b>총평</b></td>
                        <td>
                            <star-rating :starSize="30"  :read-only="true" :max-rating="10"  :rating="total" ></star-rating>
                        </td>
                    </tr> -->
                </table>
                <hr>
