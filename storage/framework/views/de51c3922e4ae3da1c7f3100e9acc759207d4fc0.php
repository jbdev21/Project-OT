			...
			<div class="col-sm-12">
				...
				<?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="testimonial">
						<h3 class="title"><?php echo e($testimonial->user->name); ?>

							<span class="post">- <?php echo e(date_formater('date_time_format', $testimonial->created_at)); ?> <?php if($testimonial->admin): ?> &nbsp;&nbsp;&nbsp;&nbsp;  --담당강사 : <?php echo e($testimonial->admin->name); ?> <?php endif; ?></span>
						</h3>
						<p class="description">
							<?php if(strlen(str_replace('\n',' ',$testimonial->message)) > 350): ?>
							<h3>
								<?php echo str_limit_wrap($testimonial->message, 100); ?>

							</h3>
								<br>
								<br>
								<a href="<?php echo e(route('testimonial.show', $testimonial->id)); ?>" class="btn btn-primary">전체보기</a>
							<?php else: ?>
								<h3>
