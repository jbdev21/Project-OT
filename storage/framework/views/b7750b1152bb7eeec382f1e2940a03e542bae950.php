<?php $__env->startSection('content'); ?>
    <?php if(is_desktop()): ?>
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <label><?php echo app('translator')->getFromJson('menu.coupon'); ?></label>
                         <a href="<?php echo e(route('admin.coupon.create')); ?>" class="btn btn-default btn-sm" ><i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('button.create'); ?></a>
                        <a class="btn btn-default btn-sm" href="<?php echo e(route('admin.coupon.index')); ?>"><i class="fa fa-reply-all"></i> <?php echo app('translator')->getFromJson('label.coupon'); ?></a>
                ...
                <form action="<?php echo e(route('admin.coupon.destroy', 0)); ?>" id="delete_all" method="post">
