...
<?php $__env->startSection('content'); ?>
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
               <?php echo app('translator')->getFromJson('label.notice'); ?>
               <button class="btn btn-default btn-sm" id="delete_all_btn"><i class="fa fa-trash"></i> <?php echo app('translator')->getFromJson('button.delete'); ?></button>
                  <a href="<?php echo e(route('admin.notice.create')); ?>" class="btn btn-default btn-sm pull-right" ><i class="fa fa-plus"></i><?php echo app('translator')->getFromJson('button.new'); ?></a>
            </div>
            <div class="x_content">
                <form action="<?php echo e(route('admin.notice.destroy', 0)); ?>" id="delete_all" method="post">
